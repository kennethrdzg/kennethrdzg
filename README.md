...
I am Kenneth Rodriguez, a computer science student from Mexico with a passion for all things about programming. I have worked with C++, Java, Angular, PostgreSQL, and a few other things. 

### 🔭 I’m currently working on ...
- Finishing college (#1 priority)
- Building my website
- Remaking my chess bot in C++ (WIP)
...
- BitTorrent Client
  ...
  - [Node.js](https://allenkim67.github.io/programming/2016/05/04/how-to-make-your-own-bittorrent-client.html)
- Neural Network
...
- Shell
  ...
  - [Write a hsell in C](https://brennan.io/2015/01/16/write-a-shell-in-c/)
- Text Editor
  - [C - Build your Own Text Editor](https://viewsourcecode.org/snaptoken/kilo/)
  - [C++ Designing a simple text editor](https://www.fltk.org/doc-1.1/editor.html)
-->
...
<!--
**kennethrdzg/kennethrdzg** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
